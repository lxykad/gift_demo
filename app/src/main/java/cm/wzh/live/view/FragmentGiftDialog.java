...
public class FragmentGiftDialog extends DialogFragment {
    ...
    private String[] catogary_price;
    private String[] catogary_name;
    ...
    private void initView(View rootView) {
        ...
        if (args == null)
            return;
        catogary_price = getResources().getStringArray(R.array.catogary_price);
        catogary_name = getResources().getStringArray(R.array.catogary_gift_name);
        ...
        for (int i = 0; i < catogary_price.length; i++) {
            Gift catogary = new Gift();
            catogary.price = catogary_price[i];
            catogary.giftName = catogary_name[i];
    ...
    public void initViewPager() {
        ...
        GiftGridViewAdapter myGridViewAdapter1 = new GiftGridViewAdapter(getActivity(), 0, 3);
        ...
        GiftGridViewAdapter myGridViewAdapter2 = new GiftGridViewAdapter(getActivity(), 1, 3);
